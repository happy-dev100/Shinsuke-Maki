...
export const projects: Project[] = [
  ...
  },
  {
    ...
    teamSize: { en: '4 engineers', ja: '4名' },
    myRole: {
      en: 'Responsible for requirements definition, system design, frontend and backend implementation, Stripe integration, and email notification setup. Infrastructure was managed on AWS by a dedicated team member.',
